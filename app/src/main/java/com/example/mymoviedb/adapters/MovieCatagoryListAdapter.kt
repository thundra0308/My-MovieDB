...
class MovieCatagoryListAdapter(private val context: Context,private val movieList :List<MoviesResultModel>): RecyclerView.Adapter<MovieCatagoryListAdapter.MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        ...
        val layoutParms = LinearLayout.LayoutParams((parent.width*0.5).toInt(),(885.toDp()).toPx())
